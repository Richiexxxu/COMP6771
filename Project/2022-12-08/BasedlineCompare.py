...
#         img_saved_path = baseline_saved_path + image_saved_name
#         print(img_saved_path, "psnr: ", psnr(img, gaussian_img, data_range=255))
...
#     img_saved_path = baseline_saved_path + image_saved_name
#     print(img_saved_path, "psnr: ", psnr(img, medianblur_img, data_range=255))
...
#     img_saved_path = baseline_saved_path + image_saved_name
#     print(img_saved_path, "psnr: ", psnr(img, meanblur_img, data_range=255))
